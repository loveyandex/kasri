...
/**
 * is created by aMIN on 5/26/2018 at 04:52
 */
...
public class MenuSample extends Application {
    ...
    final PageData[] pages = new PageData[] {
            ...
            new PageData("Hawthorn",
                    "The hawthorn is a large genus of shrubs and trees in the rose "
                            ...
                            + "Hemisphere in Europe, Asia and North America.The name hawthorn was "
                    + "originally applied to the species native to northern Europe, "
                    + "especially the Common Hawthorn C. monogyna, and the unmodified "
                    + "name is often so used in Britain and Ireland.",
                    "Crataegus monogyna"),
            new PageData("Ivy",
                    "The ivy is a flowering plant in the grape family (Vitaceae) native to eastern Asia in Japan, Korea, and northern and eastern China. "
    ...
    private class PageData {
        ...
        public PageData(String name, String description, String binNames) {
            ...
            try {
                image = new Image(new File("C:\\Users\\AminAbvaal\\Desktop\\javas\\kasri\\assets\\1x\\baseline_close_white_36dp.png").toURI().toURL().toString());
