...
public class RegressionSum {
    ...
    public static void main(String[] args) {
        ...
        final INDArray input = Nd4j.create(new double[]{0.444444, 0.3333333333333}, new int[]{1, 2});
    ...
    private static DataSetIterator getTrainingData23(int batchSize, Random rand) {
        double[] sum = new double[nSamples];
        double[] input1 = new double[nSamples];
        double[] input2 = new double[nSamples];
        for (int i = 0; i < nSamples; i++) {
